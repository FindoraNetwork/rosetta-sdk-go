...
<!-- Badges -->
<p align="center">
  <a href="https://circleci.com/gh/findoranetwork/rosetta-sdk-go/tree/master"><img src="https://circleci.com/gh/findoranetwork/rosetta-sdk-go/tree/master.svg?style=shield" /></a>
  <a href="https://coveralls.io/github/findoranetwork/rosetta-sdk-go"><img src="https://coveralls.io/repos/github/findoranetwork/rosetta-sdk-go/badge.svg" /></a>
  <a href="https://goreportcard.com/report/github.com/findoranetwork/rosetta-sdk-go"><img src="https://goreportcard.com/badge/github.com/findoranetwork/rosetta-sdk-go" /></a>
  <a href="https://github.com/findoranetwork/rosetta-sdk-go/blob/master/LICENSE.txt"><img src="https://img.shields.io/github/license/findoranetwork/rosetta-sdk-go.svg" /></a>
  <a href="https://pkg.go.dev/github.com/findoranetwork/rosetta-sdk-go?tab=overview"><img src="https://img.shields.io/badge/go.dev-reference-007d9c?logo=go&logoColor=white&style=shield" /></a>
</p>
<!-- Rosetta Tagline -->
<p align="center">
Build once. 
...
```shell
go get github.com/findoranetwork/rosetta-sdk-go/server
```
...
This is an [example](https://github.com/findoranetwork/rosetta-sdk-go/tree/master/examples/server) of how to write an implementation using the Server package in rosetta-sdk-go.
...
import (
	...
	"github.com/findoranetwork/rosetta-sdk-go/examples/server/services"
...
These packages are demoed extensively in [examples](examples) and are utilized throughout the [rosetta-cli](https://github.com/findoranetwork/rosetta-cli) tool.

### Syncer

The core of any integration is syncing blocks reliably. The [syncer](https://github.com/findoranetwork/rosetta-sdk-go/tree/master/syncer) serially processes blocks from a Data API implementation (automatically handling re-orgs) with user-defined handling logic and pluggable storage. After a block is processed, store it to a DB or send a push notification—the decision is up to you!

### Parser

When reading the operations in a block, it's helpful to apply higher-level groupings to related operations, or match operations in a transaction to some set of generic descriptions (i.e., ensure there are two operations of equal but opposite amounts). The [parser](https://github.com/findoranetwork/rosetta-sdk-go/tree/master/parser) empowers any integrator to build abstractions on top of the [building blocks](https://www.rosetta-api.org/docs/rosetta_principles.html#universal-transactions) that the Rosetta API exposes.
...
To validate `rosetta-sdk-go`, [install `rosetta-cli`](https://github.com/findoranetwork/rosetta-cli#install) and run one of the following commands:
...
* [rosetta-cli](https://github.com/findoranetwork/rosetta-cli) — Use the `rosetta-cli` tool to test your Rosetta API implementation. The tool also provides the ability to look up block contents and account balances.
